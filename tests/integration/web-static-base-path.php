...
check(str_contains($index,'href="app.css?v=20260902-3"'),'index stylesheet is base-path relative and cache-busted');
...
check(str_contains($index,'src="app.js?v=20260902-3"'),'app script is base-path relative and cache-busted');
